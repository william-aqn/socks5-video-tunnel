...
*   **Цветовое пространство**: 8-цветная палитра (3 бита на блок).
*   **Защита данных**: CRC32 + x2 избыточность внутри кадра.
*   **Гарантированная доставка**: Протокол ARQ (Seq/Ack) с автоматической ретрансляцией.
*   **Пропускная способность**: 
    *   При `blockSize=6`: ~70-100 КБ/с.
    *   При `blockSize=4`: до 250 КБ/с (зависит от FPS и качества связи).
*   **Ограничение**: Кодек чувствителен к сильному JPEG-сжатию и изменению масштаба. Рекомендуется использовать платформы с поддержкой HD-видео (720p/1080p).
